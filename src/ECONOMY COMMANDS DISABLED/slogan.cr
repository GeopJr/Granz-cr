module Granz
  module Slogan
    BOT.on_message_create do |payload|
      ...
      if (payload.content.starts_with? PREFIX[0] + "slogan") || (payload.content.starts_with? PREFIX[1] + "slogan") || (payload.content.starts_with? PREFIX[2] + "slogan") || (payload.content.starts_with? PREFIX[3] + "slogan") || (payload.content.starts_with? PREFIX[4] + "slogan")
