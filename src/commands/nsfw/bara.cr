  ...
  module Commands
    module Bara
      ...
      def execute(payload : Discord::Message, args : Array(String))
        ...
        i = 0
        response = HTTP::Client.get("https://api.rule34.xxx/index.php?page=dapi&s=post&q=index&pid=#{rand(50)}&tags=bara%20-furry%20-furry_only%20-anthro%20-3d%20-3d_(artwork)%20-forced%20-yaoi%20-pokemon%20-canid%20-humanoid%20-humanoid_penis%20-mammal%20-animal_humanoid%20-fur%20-vagina%20-pussy")
