  ...
  module Commands
    module Donate
      ...
      def execute(payload : Discord::Message, args : Array(String))
        ...
        return BOT.create_message(payload.channel_id, "", Discord::Embed.new(colour: 0xff0000, title: "Available coins:", description: "```\n#{DONATION_LINKS.keys.join(", ")}\n```", footer: Discord::EmbedFooter.new(text: "Thanks for donating! Don't forget to leave your username so I can thank you personally!"))) unless DONATION_LINKS.keys.includes?(args.join(" ").upcase)
